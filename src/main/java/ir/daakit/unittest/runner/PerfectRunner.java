...
public final class PerfectRunner extends BlockJUnit4ClassRunner implements CaspianTest {
    public PerfectRunner(Class<?> clazz) throws InitializationError {
        super(clazz);
    }
        ...
        try {
            test = (new ReflectiveCallable() {
                protected Object runReflectiveCall() throws Throwable {
                    return PerfectRunner.this.createTest();
                }
            }).run();
        } catch (Throwable e) {
